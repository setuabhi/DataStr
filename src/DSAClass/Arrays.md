Questions:
      ...
      4. How to sort Integer[] array?
      5. How to sort int[] array?
...
Answers:
      ...
      4. Integer[] arrNonPrimitive = {-1, -3, 3, -2, 4, 5, -1, 0};
         Arrays.sort(arrNonPrimitive, Collections.reverseOrder()); to sort in descending order,
      5. If it's primitive then Collections.reverseOrder() won't work as it works on Object only:
