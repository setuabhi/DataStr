1. The Singleton Design Pattern ensures that a class has only one instance throughout the application and provides a global point of access to that instance.
   ...
   Thread pool
   EmailService 
2. Two main points: a) private constructor and b) public static getInstance method which will create instance for the first time then will return static instance
